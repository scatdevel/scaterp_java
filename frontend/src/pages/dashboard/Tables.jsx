...
//   // New state for existing land details
//   const [landDetails, setLandDetails] = useState(null);

//   // Function to fetch existing land details
//   const fetchLandDetails = async () => {
//     try {
//       const response = await axios.get('http://localhost:8080/users/land-details'); // Adjust the endpoint as needed
//       if (response.data) {
//         setLandDetails(response.data);
//         setFormData(response.data); // Populate form with existing land details
//         setIsFieldsDisabled(true);
//       }
//     } catch (error) {
...
//   useEffect(() => {
//     fetchLandDetails(); // Fetch land details on component mount
//   }, []);
...
//   const fetchLandDetails = async () => {
//     try {
//       const response = await axios.get(`http://localhost:8080/users/land-details/${id}`); // Adjust the endpoint as needed
//       if (response.data) {
//         setLandDetails(response.data);
//         setFormData(response.data); // Populate form with existing land details
//         setIsFieldsDisabled(true);
